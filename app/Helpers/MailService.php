...
class MailService {
    ...
    public static function sendOrderConfirmation($order) {
        ...
        foreach ($items as $it) {
            ...
            $itemsHtml .=
                '<tr>'
                . '<td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;color:#333">' . $pname . '</td>'
                . '<td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;text-align:center;color:#666">' . $qty . '</td>'
                . '<td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;text-align:right;font-weight:600;color:#e30000">' . $sub . '&#x111;</td>'
                . '</tr>';
        }
        ...
        $body =
            ...
            . '<th style="padding:8px 12px;font-size:12px;text-align:left;color:#666;font-weight:600">S&#x1ea3;n ph&#x1ea9;m</th>'
            . '<th style="padding:8px 12px;font-size:12px;text-align:center;color:#666;font-weight:600">SL</th>'
            . '<th style="padding:8px 12px;font-size:12px;text-align:right;color:#666;font-weight:600">Th&agrave;nh ti&#x1ec1;n</th>'
            . '</tr></thead>'
            . '<tbody>' . $itemsHtml . '</tbody>'
            . '<tfoot>'
            . '<tr><td colspan="2" style="padding:8px 12px;font-size:13px;color:#888;text-align:right">Ph&iacute; v&#x1eadn chuy&#x1ec3;n:</td><td style="padding:8px 12px;font-size:13px;text-align:right">' . $shipFee . '</td></tr>'
            . '<tr style="background:#fff7f7"><td colspan="2" style="padding:10px 12px;font-size:14px;font-weight:800;text-align:right;color:#333">T&#x1ed5;ng c&#x1ed9;ng:</td><td style="padding:10px 12px;font-size:15px;font-weight:900;text-align:right;color:#e30000">' . $total . '&#x111;</td></tr>'
            . '</tfoot></table>'
